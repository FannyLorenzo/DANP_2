...
public class MqttHelper implements MqttCallback {
    ...
    private final static String USERNAME = "h1TXtEwjr6MVB5abxSJi";
    ...
    public void publishBatch(List<MqttMessageWrapper> messages, int delay, String topic, int qos) {
        ...
        try {
            ...
            //while (MESSAGE_ID2 < messages.size()) {
                ...
                if (mqttAndroidClient.isConnected()) {
                    ...
                    String jsonString = "{\"Temperatura (C°)\":"+temp+" , \"Topic\":"+topic+" ,\"Qos\":"+qos+" }";
